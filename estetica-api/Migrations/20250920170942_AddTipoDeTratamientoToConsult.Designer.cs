...
namespace dentist_panel_api.Migrations
{
    ...
    [Migration("20250920170942_AddTipoDeTratamientoToConsult")]
    partial class AddTipoDeTratamientoToConsult
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("dentist_panel_api.Entities.Consult", b =>
                {
                    ...
                    b.Property<Guid?>("TipoDeTratamientoId")
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("TipoDeTratamientoId");
            ...
            modelBuilder.Entity("dentist_panel_api.Entities.Doctor", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("dentist_panel_api.Entities.TipoDeTratamiento", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("dentist_panel_api.Entities.Appointment", b =>
                {
                    b.HasOne("dentist_panel_api.Entities.Doctor", "Doctor")
                        .WithMany()
            ...
            modelBuilder.Entity("dentist_panel_api.Entities.Consult", b =>
                {
                    ...
                    b.HasOne("dentist_panel_api.Entities.TipoDeTratamiento", "TipoDeTratamiento")
                        .WithMany()
                        .HasForeignKey("TipoDeTratamientoId");
                    ...
                    b.Navigation("TipoDeTratamiento");
                });
